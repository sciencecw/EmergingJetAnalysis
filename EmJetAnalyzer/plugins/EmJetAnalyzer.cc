  ...
  vertex_ ()
{
  // Config-independent initialization
  {
    ...
    h1_ = fs->make<TH1F>("h1","Eta of Jets with Alphamax>0; Eta; Count",13,-3.,3.);
    h2_ = fs->make<TH1F>("h2","Eta of Jets with Alphamax=0; Eta; Count",13,-3.,3.);
    otree_.Branch(tree_);
  }
